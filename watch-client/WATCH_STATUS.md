...
|---|---|---|---|
| Wear OS (Galaxy Watch 8 Classic) | **v0.17** (wear vc116) | Play internal testing | tagged 2026-09-20 late: dial haptic per detent (owner-confirmed on the wrist), password field masked; v0.16 = Discard-from-focus fix; v0.15 = the feature batch |
...
| Phone companion "Jacked Sync" (Android) | **v0.17** (phone vc16) | Play internal testing | no functional change since v0.14 |
